...
- `/whispy/`
  ...
  - `src/whispy/` — Python package with modular components:
...
- **Main Application**: Run the project via `whispy_daemon.py`.
...
- **Explore `src/whispy/core/engine.py`** for the main application logic.
